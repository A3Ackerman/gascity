...
// inline emission put a block of unconditional stderr lines above the output of
// every gc command in every agent's context (three from the bundled gastown
// pack alone), and an agent misread that banner as the
